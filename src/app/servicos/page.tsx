          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {frentes.map((f, i) => (
              <Link
                ...
                className="cartao group relative overflow-hidden p-9 transition-all duration-500 hover:-translate-y-1 hover:border-rosa/40 md:p-11"
              >
                <span
                  aria-hidden
                ...
                <div className="relative flex items-start justify-between gap-6">
                  <IconeFrente slug={f.slug} className="h-9 w-9 text-acento transition-transform duration-500 group-hover:scale-110" />
