...
export function BotaoWhatsapp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_30px_-6px_rgba(37,211,102,0.5)] transition-transform duration-300 hover:scale-105 md:bottom-8 md:right-8"
    >
