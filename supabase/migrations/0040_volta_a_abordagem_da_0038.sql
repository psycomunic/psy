-- =====================================================================
-- 0040 - Volta o texto da 0038. A 0039 cortou demais.
--
-- O QUE ACONTECEU
--
-- A 0039 levou a abordagem de 155 para 82 palavras. Ninguém tinha
-- pedido para cortar informação, e ela não cortou: tirou rodeio,
-- repetição e explicação do óbvio. Só que o resultado ficou seco, e
-- quem envia leu e não quis.
--
-- É uma lição sobre o texto, e não sobre o método: nem toda palavra que
-- pode sair DEVE sair. "Meu nome é Angelo, da Psy Comunic" e "Sou o
-- Angelo, da Psy Comunic" carregam a mesma informação e não soam igual.
-- A segunda economiza duas palavras e some com a cortesia.
--
-- O QUE VOLTA
--
-- O texto EXATO que a 0038 aplicou, copiado dela, e não regerado. Se
-- fosse regerado por script, um ajuste qualquer feito no gerador desde
-- então entraria junto sem ninguém ver, e "voltar ao de antes" viraria
-- "voltar a mais ou menos o de antes".
--
-- Continuam cinco mensagens, a oportunidade com o motivo escrito, os
-- serviços do site e a call de 30 minutos.
-- =====================================================================
